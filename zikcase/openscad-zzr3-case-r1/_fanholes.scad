// swiped from someone on Thingiverse
// Sorry, I need to look up which Thing it was to make a proper reference :(

module fanholes ( dia = 70, holedia = 10, height = 10 ) {
    // How large is the fan rotor ? (mm)
RotorDiameter= dia;
// How large should each hole be ? (mm)
HolesDiameter= holedia;
